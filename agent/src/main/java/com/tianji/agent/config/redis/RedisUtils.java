...
public class RedisUtils {
    ...
    @Autowired
    private RedisUtilsProperties redisUtilsProperties;
    ...
    public void set(String key, Object value) {
        redisTemplate.opsForValue().set(key, value, redisUtilsProperties.getDefaultTimeout(), TimeUnit.SECONDS);
    }
    ...
    public Set<String> scan(String pattern, int count) {
        ...
        try (Cursor<byte[]> cursor = redisTemplate.getConnectionFactory()
            ...
            log.error("Redis SCAN 异常, pattern={}", pattern, e);
        }
    ...
    public void deleteByPattern(String pattern) {
        Set<String> keys = scan(pattern, 200);
        if (!keys.isEmpty()) {
